...
/** A Java Class to represent a point in a 3D grid
 *     This class inherits from (adds on to) the Point2d class 
 * 
 *   @author  Pat Troy
 */
 ...
 public static void main (String[] args)
   {
    ...
    // Code to test Access Modifiers: Lab 8, Questions 2 and 5
     //pt1.x = 1;               // LINE 81
     //pt1.y = 2;               // LINE 82
     //pt1.debug = true;        // LINE 83
